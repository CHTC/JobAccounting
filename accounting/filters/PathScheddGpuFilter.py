...
class PathScheddGpuFilter(BaseFilter):
    name = "PATh facility schedd gpu job history"
    ...
    def compute_custom_columns(self, data, agg, agg_name):
        ...
        badput_gpu_time = []
        total_gpu_time = []
        for (last_wallclock_time, committed_time, badput_time, total_time, cpus, gpus) in zip(
